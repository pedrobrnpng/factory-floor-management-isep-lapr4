...
public class StartOfActivityMessage extends Message {
    ...
    public boolean sameAs(Object other) {
        final StartOfActivityMessage startOfActivityMessage = (StartOfActivityMessage) other;
        return super.sameAs(other) && this.productionOrder.equals(startOfActivityMessage.productionOrder);
    ...
    public String toString() {
        return "eapli.base.messagesmanagement.domain.StartOfActivityMessage[ id=" + super.identity() + " ]";
    }
