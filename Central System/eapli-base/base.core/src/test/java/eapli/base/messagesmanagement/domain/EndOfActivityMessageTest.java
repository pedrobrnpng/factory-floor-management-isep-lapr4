 ...
 * @author Utilizador
 */
public class EndOfActivityMessageTest {
    ...
    //Type of Message
    private static final Description TYPE_OF_MESSAGE = Description.valueOf("S9");
    //Date and hour
    ...
    public void ensureEndOfActivityMessageCanBeCreated() {
        new EndOfActivityMessage(MACHINE, TYPE_OF_MESSAGE, DATEHOUR, PRODUCTION_ORDER);
        assert (true);
    }
    
    @Test
    public void ensureEndOfActivityMessageCanBeCreatedWithouProductionOrder() {
        new EndOfActivityMessage(MACHINE, TYPE_OF_MESSAGE, DATEHOUR, null);
    }
